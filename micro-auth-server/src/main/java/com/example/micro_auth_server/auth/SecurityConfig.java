package com.example.micro_auth_server.auth;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            User user = userClient.loginUser(username, ""); // Solo para obtener el usuario, sin verificar contraseña aquí
            if (user == null) {
            ...
            return org.springframework.security.core.userdetails.User.builder()
                    ...
                    .password(user.getPassword()) // Asegúrate de que esté hasheada
                    .roles(user.getRole()) // Si `user.getRole()` devuelve un solo rol
                    .build();
        };
    }
